...
(function($, undefined) {
    ...
    $.extend($.tmpl, {
        tag: {
            ...
            /* for 标记后不可以有空格“不允许{%for (xxx)%}”只能“{%for(xxx)%}” */
            "for": {
    ...
    function buildTmplFn(markup) {
        ...
        var depreciated_parse = function() {
            //parsed_markup = parsed_markup.replace(regex.js_code, "');$2;__.push('");
        ...
        var parsed_markup_data = "var $=$,call,__=[],$data=$item.data; \nwith($data){\n__.push('";
